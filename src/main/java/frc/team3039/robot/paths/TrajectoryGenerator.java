...
public class TrajectoryGenerator {
        ...
        public class TrajectorySet {
                ...
                public final LazyLoadTrajectory tommysPath;
                ...
                private TrajectorySet() {
                        ...
                        tommysPath = new LazyLoadTrajectory(()->getTommysPath());

                }
                private Trajectory<TimedState<Pose2dWithCurvature>> getTommysPath() {
                        ...
                        return generateTrajectory(true, waypoints,
                                        ...
                                        0, 40, kFirstPathMaxVel, kFirstPathMaxAccel,
